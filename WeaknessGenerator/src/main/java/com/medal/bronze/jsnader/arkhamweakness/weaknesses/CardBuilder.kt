...
class CardBuilder(private val mScenarioType: ScenarioType?) {
    ...
    private fun setupFullWeaknessList() { //Keep alphabetical for easy reference later.
        ...
        val thrtnVisWeakness = Weakness("The 13th Vision", CampaignAffinity.CIRCLE_UNDONE, 1, R.drawable.weakness_thirteenth_vision)
        ...
        val thrDaGtsWeakness = Weakness("Through the Gates", CampaignAffinity.CIRCLE_UNDONE, 1, R.drawable.weakness_through_the_gates)
